...
object : Port() {
    override val name = "sepol"
    override val version = "3.1"
    override val mavenVersion = "${version}"
    override val licensePath = "libsepol/COPYING"

    override val license = License(
        "LGPL 2.1",
        "https://github.com/topjohnwu/selinux/blob/master/libsepol/COPYING"
    )

    override val modules = listOf(Module("sepol"))
